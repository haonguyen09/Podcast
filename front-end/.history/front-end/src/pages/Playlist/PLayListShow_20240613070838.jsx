...
const PLayListShow = () => {
    ...
    return (
        ...
        <div className='playlistShow-list d-grid'>
            ...
            <audio ref={audioRef} src={`${process.env.REACT_APP_BACKEND}/uploads/${data[currentAudioIndex].audio}`} onEnded={handleAudioEnded} /> <audio ref={audioRef} src={`${process.env.REACT_APP_BACKEND}/uploads/${data[currentAudioIndex].audio}`} onEnded={handleAudioEnded} />
    </div>
    )
}
