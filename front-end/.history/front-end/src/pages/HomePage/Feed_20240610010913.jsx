...
const Feed = () => {
    ...
    useEffect(() => {
        const fetchListPodcast = async () => {
            ...
            const listTopic = response.data.topics.map(topics => topics.podcasts)
            // console.log("listTopic", listTopic)
            // console.log("response feed", response.data.topics[0].podcasts[0].userId)
    ...
    return (
        <div className='feed'>
            ...
            <div className='feed-main'>
                {
                    listPodcast[0].map((podcast, index) => (
                            ...
                            <div className='feed-item-header d-flex justify-content-between align-items-center'>
                                <div className='feed-author d-flex justify-content-center align-items-center'>
                                    ...
                                    <div className='feed-author-content'>
                                        ...
                                        <div className='feed-date text-start'>{podcast.createdAt}</div>
                                    </div>
                                </div>
