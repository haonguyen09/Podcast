...
const loginUser = (user) => {
    return new Promise(async (resolve, reject) => {
        ...
        if (user) {
            ...
            const checkPassword = bcrypt.compareSync(user.password, passwordHash)
            ...
            try {
                ...
                const access_token = generateAccessToken(response)
                const refresh_token = generateRefreshToken(response)
