...
const SignUpStep1 = (props) => {
  ...
  const handleNext = () => {
    ...
    updateObjectInLocalStorage('signUpData', {email : email, firstName: firstName, lastName: lastName});
  };
  ...
  return (
    <div  className='signUp-s1-main'>
      <div class="signUp-s1-info d-grid">
          ...
          <div>
              <h4>Avatar</h4>
              <input type='file' placeholder='Your Email' value={avatar} onChange={e => setAvatar(e.target.value)}/>
          </div>
      </div>
