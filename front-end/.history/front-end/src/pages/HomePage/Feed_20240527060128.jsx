...
import { faCheck, faStar, faEllipsisV, faTimesCircle } from '@fortawesome/free-solid-svg-icons'
            ...
            <div className='feed-main'>
                <div className='feed-item'>
                    <div className='feed-item-header'>
                        <div className='feed-item-header-right'>
                            ...
                            <div className='feed-item-header-text'>
                                <h3 className='feed-item-header-name'>James Killened
                    ...
                    <div className='feed-item-content'>
                        <img src='' className='feed-item-content-img' />
                        <div className='feed-item-content-right'>
                            ...
                            <div className='feed-item-content-time'>
                                <div className='feed-item-content-remaining'>
