        ...
        const fetchInitialStatus = async () => {
            if (token) {
                try {
                    ...
                    const checkLike = statusLike.data.filter(item => item.userId._id === decoded.id && item.podcastId._id === data._id)
                    ...
                    const checkRate = statusRate.data.filter(item => item.userId._id === decoded.id && item.podcastId._id === data._id)
