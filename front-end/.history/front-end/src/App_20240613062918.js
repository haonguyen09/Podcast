...
function App() {
  ...
  if (loading) {
    return <ReactLoading type="spinningBubbles" color="hsl(248, 57%, 60%)" height={'20%'} width={'20%'} />
  }

  return (
    <div>
      <ReactLoading type="spinningBubbles" color="hsl(248, 57%, 60%)" height={'5%'} width={'5%'} style={{display: "flex", justifyContent:"center", alignItems:"center", width: "100%", height: "100%"}} />
      <Router>
        <Routes>
