...
const PLayListShow = () => {
    ...
    return (
        ...
        <div className='playlistShow-list d-grid'>
            ...
            <audio ref={audioRef} src={`/uploads/${data[currentAudioIndex].audio}`} onEnded={handleAudioEnded} /> <audio ref={audioRef} src={`/uploads/${data[currentAudioIndex].audio}`} onEnded={handleAudioEnded} />
    </div>
    )
}
