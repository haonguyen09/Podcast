            ...
            <div className='createEpisodes-main text-start'>
                <div className='createEpisodes-thumbnail'>
                    ...
                    <div className='createEpisodes-wrapper'>
                        <label for="createEpisodes-upload text-centen" className='createEpisodes-upload-label'>
                            <UploadIcon />
                ...
                <div className='createEpisodes-thumbnail'>
                    <h4>Audio</h4>
                    <div className='createEpisodes-wrapper'>
                        <label for="createEpisodes-upload-audio text-center" className='createEpisodes-upload-label'>
                            <UploadIcon />
                            <h4>Drag and drop or browse to choose a file</h4>
