        ...
        <div className='playlistShow-list d-grid'>
            <div className='playlistShow-item d-flex align-items-center'>
                ...
                <div className='playlistShow-info'>
                        <PodcastItemComponent audioUrl={`${process.env.REACT_APP_BACKEND}/uploads/${data[currentAudioIndex]}`} classWave='playlistShow-width' data={ data[currentAudioIndex] } />
            ...
            <audio ref={audioRef} src={`${process.env.REACT_APP_BACKEND}/uploads/${data[currentAudioIndex]}`} onEnded={handleAudioEnded} />
    </div>
    )
}
