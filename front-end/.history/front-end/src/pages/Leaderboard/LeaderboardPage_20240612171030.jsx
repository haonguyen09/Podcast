...
const LeaderboardPage = () => {
    ...
    const token = user.access_tokens
    let decoded
    ...
    const handleFollow = async (id) => {
        const userCurrent = getDetailsUser(decoded?.id)
    ...
    const data = listUser.map((item, index) => {
        ...
        return {
            ...
            Action: <button className="button button--orangebg" onClick={() => handleFollow(item.userId._id)}>Follow</button>,
        }
