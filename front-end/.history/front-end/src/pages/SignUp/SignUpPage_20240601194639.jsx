    ...
    return (
        <div className='signUp d-grid'>
            ...
            <div className='signUp-right d-flex justify-content-center align-items-center'>
                <div className='signUp-rightIn d-flex justify-content-center align-items-center flex-column'>
                    <div className='signUp-rightIn-text text-end'>Already a member? <span>Sign In</span></div>
                    ...
                    <h1 className='text-start'>Discover better insight every single day</h1>
