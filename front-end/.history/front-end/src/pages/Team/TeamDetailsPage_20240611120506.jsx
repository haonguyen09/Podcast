...
const TeamDetailsPage = () => {
    ...
    const handleInviteSubmit = async () => {
        ...
        try {
            ...
            if (response) {
                ...
                // Optionally, update local state to reflect changes in the UI
                dataTeam.members = response.data.members; // Update local state with response
                setShowModal(false);
            } else {
    ...
    const handleRemove = (id) => {
        const updatedMembers = dataTeam.members.filter(member => member._id !== id)
        console.log("updatedMembers",updatedMembers)
        const response = updateTeam(dataTeam._id, { members: updatedMembers._id })
        if (response) {
