        ...
        const fetchInitialStatus = async () => {
            if (token) {
                try {
                    ...
                    const checkLike = statusLike.data.filter(item => console.log(item.userId._id === decoded.id && item.podcastId._id === data._id))
                    ...
                    const checkRate = statusRate.data.filter(item => console.log(item.userId._id === decoded.id && item.podcastId._id === data._id))
