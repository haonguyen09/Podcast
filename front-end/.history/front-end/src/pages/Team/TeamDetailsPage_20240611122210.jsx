...
import { updateTeam, getTeamDetails } from '../../services/TeamService'; // Ensure you have getTeamDetails service
...
const TeamDetailsPage = () => {
    ...
    const fetchUpdatedTeamData = async () => {
        try {
            const response = await getTeamDetails(dataTeam._id); // Adjust this according to your service
            if (response) {
