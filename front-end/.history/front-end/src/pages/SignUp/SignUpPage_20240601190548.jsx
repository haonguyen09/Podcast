    ...
    return (
        <div className='signUp d-grid'>
            ...
            <div className='signUp-right'>
                <div className='signUp-rightIn'>
                    <div>Already a member? <span>Sign In</span></div>
                    <div className='signUp-right-grid d-grid'>
                        ...
                        <div className='d-flex justify-content-end'>
                            <div class="signUp-right-img3 d-flex justify-content-end"><img src={img3} alt='avatar' className=' d-flex justify-content-end'/></div>
                    ...
                    <h1>Discover better insight every single day</h1>
