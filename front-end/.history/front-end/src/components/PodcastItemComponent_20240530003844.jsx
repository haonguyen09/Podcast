...
const PodcastItemComponent = ({audioUrl}) => {
  ...
  const handlePlayPause = () => {
    ...
    return (
        ...
        <div class="podcastItem-header d-flex align-items-center">
        ...
        <div className="podcastItem-wave-wrapper d-flex align-items-center">
            <div ref={waveformRef} className="podcastItem-wave" />
