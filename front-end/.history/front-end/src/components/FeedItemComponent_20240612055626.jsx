        ...
        const fetchInitialStatus = async () => {
            if (token) {
                try {
                    ...
                    const checkLike = statusLike.data.filter(item => console.log(item.userId._id === decoded.id ))
                    ...
                    const checkRate = statusRate.data.filter(item => console.log(item.userId._id === decoded.id ))
