    ...
    return (
        <div className='createTeam text-start'>
            ...
            <div className='createTeam-members'>
                <h4>Member</h4>
                <div className='createTeam-avatar-wrap d-flex justify-content-between align-items-center'>
                    <div className='createTeam-avatar d-flex justify-content-center align-items-center'>
                        <img src={img} />
                        <h5>Axel</h5>
                    </div>
