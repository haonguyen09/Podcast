...
const SignUpStep1 = (props) => {
  ...
  const handleNext = async () => {
    ...
    updateObjectInLocalStorage('signUpData', { email: email, firstName: firstName, lastName: lastName, avatar: avatarFile, avatarPreview: avatarPreview  });
  ...
  return (
    <div  className='signUp-s1-main'>
      <div class="signUp-s1-info d-grid">
          ...
          <div>
            <h4>Avatar</h4>
            <div class="signUp-s1-avatar">
              <input type='file' ref={avatarRef} onChange={handleAvatarChange} />
